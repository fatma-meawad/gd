...
describe("Test suite for /s1/admins/{id}", () => {
  describe("Test suite for put /s1/admins/{id}", () => {
    test("Test case: /s1/admins/{id} with Request Example: ValidExample", async () => {
      const response = await request(app)
        .put(baseUrl + "/s1/admins/{id}")
    ...
    test("Test case: /s1/admins/{id} with Request Example: InvalidExample", async () => {
      const response = await request(app)
        .put(baseUrl + "/s1/admins/{id}")
        .set("Accept", "application/json")
        .query({})
