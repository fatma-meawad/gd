...
describe("postProductsDb", () => {
  jest.mock("/workspaces/galleria-dashboard/server/components/products/tests/unit/mock/products.json", () => mockProducts);
    ...
    it("should successfully save the product", async () => {
        ...
        expect(result.data).toHaveProperty('product_name', validProduct.product_name);
        expect(result.data).toHaveProperty('category_id', validProduct.category_id);
        expect(result.data).toHaveProperty('short_description', validProduct.short_description);
        expect(result.data).toHaveProperty('detailed_description', validProduct.detailed_description);
